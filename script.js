...
// ===============================
// Problem 4: Write and call a function using a parameter
// ===============================
...
// ===============================
// Problem 5: Use conditionals to filter shared items
// ===============================
let sharedFoods = [];
...
if (myFavoriteFoods.length > popularEuropeanFoods.length) {
  console.log("Problem 6 ✅ I have more favorites than the popular list.");
} else if (myFavoriteFoods.length < popularEuropeanFoods.length) {
  console.log("Problem 6 ✅ The popular list has more foods.");
} else {
  console.log("Problem 6 ✅ Both lists are the same length.");
}

// ===============================
// Problem 7: Add a new food to my list
// ===============================
...
// ===============================
// Problem 8: Function to return multi-word foods
// ===============================
...
function summary() {
  ...
  console.log("• There are " + popularEuropeanFoods.length + " popular foods.");
  console.log("• We share " + sharedFoods.length + " foods in common.");
}
